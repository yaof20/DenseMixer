...
CONFIG_FILES=(
    # "qwen1.5_esft_law_lr5e-4_unfrozen_ste.yaml"
    # "qwen1.5_esft_translation_lr1e-4_unfrozen_ste.yaml"
    ...
    "qwen1.5_esft_summary_lr1e-6_unfrozen_ste.yaml"
...
for config_file in "${CONFIG_FILES[@]}"; do
    ...
    # define the command
    CMD="CUDA_VISIBLE_DEVICES=0,1,2,3 llamafactory-cli train examples/train_lora/qwen1.5moe/${method}/${config_file}"
