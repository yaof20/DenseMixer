...
CONFIG_FILES=(
    # "qwen1.5_esft_law_lr5e-4.yaml"
    # "qwen1.5_esft_law_lr5e-4_unfrozen.yaml"
    # "qwen1.5_esft_intent_lr1e-5.yaml"
    # "qwen1.5_esft_intent_lr5e-6.yaml"
    # "qwen1.5_esft_intent_lr1e-6.yaml"
    # "qwen1.5_esft_translation_lr1e-4.yaml"
    # "qwen1.5_esft_translation_lr2e-4.yaml"
    # "qwen1.5_esft_translation_lr3e-4.yaml"
    # "qwen1.5_esft_translation_lr5e-4.yaml"
    # "qwen1.5_esft_intent_lr2e-4.yaml"
    # "qwen1.5_esft_intent_lr3e-4.yaml"
    # "qwen1.5_esft_intent_lr5e-4.yaml"
