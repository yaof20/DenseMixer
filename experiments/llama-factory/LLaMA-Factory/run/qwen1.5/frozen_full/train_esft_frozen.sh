...
CONFIG_FILES=(
    "qwen1.5_esft_law_lr1e-5_frozen.yaml"
    "qwen1.5_esft_intent_lr1e-5_frozen.yaml"
    # "qwen1.5_esft_intent_lr5e-6.yaml"
    # "qwen1.5_esft_intent_lr1e-6.yaml"
    "qwen1.5_esft_translation_lr1e-5_frozen.yaml"
    ...
    "qwen1.5_esft_summary_lr1e-6_frozen.yaml"
