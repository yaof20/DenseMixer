...
local_path="/mnt/weka/home/shibo.hao/feng/code/MoE-Finetune/LLaMA-Factory/saves/qwen1.5-moe-a2.7b/"
method="full"
...
experiment_names=(
    ...
    #  "qwen1.5_esft_law_lr1e-5"
    "qwen1.5_ammath_lr1e-5"
    #  "qwen1.5_esft_summary_lr1e-6"
    #  "qwen1.5_esft_translation_lr1e-5"
...
for experiment_name in "${experiment_names[@]}"; do
    ...
    # for ckpt in 100 200 300 400 500 553; do
    # for ckpt in 117 234 351 468; do
    for ckpt in 118 236 354; do
    ...
    # for ckpt in 29 58 87 116 140; do
        ...
        checkpoint_path="${local_path}/${method}/sft_bs64/${experiment_name}/checkpoint-$ckpt"
