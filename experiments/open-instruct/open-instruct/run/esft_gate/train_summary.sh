...
# ESFT-Gate
bash scripts/train/finetune/esft.sh --task summary --model olmoe --total_batch_size 256 --num_train_epochs 4 --devices 1,2 --port 29014 --lr 5e-3 --per_device_train_batch_size 2 --per_device_eval_batch_size 2 --expert_type gate