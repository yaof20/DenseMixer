...
# Frozen Router-lora
bash scripts/train/finetune/lora_all.sh --task gsm --model olmoe --total_batch_size 256 --num_train_epochs 4 --devices 0,1 --port 29000 --lr 1e-4 --per_device_train_batch_size 4 --per_device_eval_batch_size 4