...
# Frozen Router-Full
bash scripts/train/finetune/full.sh --task codealpaca --model olmoe --total_batch_size 256 --num_train_epochs 4 --devices 0,1 --port 29000 --lr 1e-6 --per_device_train_batch_size 4 --per_device_eval_batch_size 4 --freeze_gate True